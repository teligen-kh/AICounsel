#!/usr/bin/env python3
"""
LLaMA 3.1 8B Instruct GGUF 모델 다운로드
"""
...
def download_llama_3_1():
    ...
    alternative_urls = [
        ...
        "https://huggingface.co/TheBloke/Llama-3.1-8B-Instruct-GGUF/resolve/main/llama-3.1-8b-instruct.Q5_K_M.gguf",
        "https://huggingface.co/TheBloke/Llama-3.1-8B-Instruct-GGUF/resolve/main/llama-3.1-8b-instruct.Q4_0.gguf"
    ]
    ...
    print(f"🔄 LLaMA 3.1 8B Instruct GGUF 모델 다운로드 시작")
    ...
    try:
        ...
        if actual_size < 1024**3:  # 1GB 미만이면 문제
...
if __name__ == "__main__":
    print("LLaMA 3.1 8B Instruct GGUF 모델 다운로드")
    print("=" * 50)
    
    success = download_llama_3_1()
    
    if success:
        print("\n✅ 다운로드 성공!")
        print("이제 LLaMA 3.1 8B 모델을 사용할 수 있습니다.")
    else:
        print("\n❌ 다운로드 실패!")
        sys.exit(1) 