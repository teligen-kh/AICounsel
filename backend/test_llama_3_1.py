#!/usr/bin/env python3
"""
Llama-3.1-8B-Instruct 모델의 한국어 응답 능력 테스트
"""
...
def test_llama_3_1_korean():
    """Llama-3.1-8B-Instruct 모델의 한국어 응답 테스트"""
    
    print("=" * 60)
    print("Llama-3.1-8B-Instruct 모델 한국어 응답 테스트")
    print("=" * 60)
